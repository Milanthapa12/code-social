...
export default function Bookmarked() {
    ...
    if (status === 'error') {
        return <p className='text-center text-destructive'>
            An Error occurred while loading bookmarked.
        </p>
    }

    if (status === "success" && posts.length === 0 && !isFetching) return <p className='text-center text-muted-foreground'>No bookmarked availble.</p>
